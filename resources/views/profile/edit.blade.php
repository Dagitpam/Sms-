...
<div class="alert alert-warning alert-lg"> &nbsp;
    ...
    <span>
    <b> Warning - </b>Opps!  you do not have access to register courses. Click   <button class="btn btn-success btn-sm" type="submit" value="Pay Now!" form="paystack">
        Here
   </button> to proceed with your payment</span>
</div>
@endif
    <div class="row">
        <div class="col-md-8">
    ...
    <form method="POST" action="/pay" accept-charset="UTF-8" class="form-horizontal" role="form" id="paystack">
        <div class="row" style="margin-bottom:40px;">
            <div class="col-md-8 col-md-offset-2">
                ...
                <input type="hidden" name="amount" value="2000"> {{-- required in kobo --}}
                <input type="hidden" name="currency" value="NGN">
                {{-- <input type="hidden" name="service_type" value="airtime"> --}}
